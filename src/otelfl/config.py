...
class Settings:
    flagd_url: str = field(
        default_factory=lambda: os.environ.get("OTELFL_FLAGD_URL", "http://10.0.0.5:8080/feature")
    )
    locust_url: str = field(
        default_factory=lambda: os.environ.get("OTELFL_LOCUST_URL", "http://10.0.0.5:8080/loadgen/")
    )
